...
[How to find where unwanted security headers are set | Как узнать где установлены нежелательные заголовки безопасности]
(https://really-simple-ssl.com/how-to-find-where-security-headers-are-set/}
